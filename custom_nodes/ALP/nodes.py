...
class LP_Engine:
    ...
    def get_face_bboxes(self, image_rgb):
        ...
        pred = detect_model(image_rgb, conf=0.7, device="", verbose=False)
...
class ExpressionEditor:
    ...
    def run(self, rotate_pitch, rotate_yaw, rotate_roll, blink, eyebrow, wink, pupil_x, pupil_y, aaa, eee, woo, smile,
        ...
        # Image.fromarray(out).save("test_output.jpg")
        ...
        return {"ui": {"images": results}, "result": (Image.fromarray(out), new_editor_link, es)}
